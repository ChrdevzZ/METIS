...
/* gklib.c */
GK_MKBLAS_PROTO_EX(i, idx_t, idx_t, METIS_EXPORT)
GK_MKBLAS_PROTO_EX(r, real_t, real_t, METIS_EXPORT)
GK_MKALLOC_PROTO_EX(i, idx_t, METIS_EXPORT)
GK_MKALLOC_PROTO_EX(r, real_t, METIS_EXPORT)
GK_MKALLOC_PROTO_EX(ikv, ikv_t, METIS_EXPORT)
GK_MKALLOC_PROTO_EX(rkv, rkv_t, METIS_EXPORT)
GK_MKPQUEUE_PROTO_EX(ipq, ipq_t, idx_t, idx_t, METIS_EXPORT)
GK_MKPQUEUE_PROTO_EX(rpq, rpq_t, real_t, idx_t, METIS_EXPORT)
GK_MKRANDOM_PROTO_EX(i, idx_t, idx_t, METIS_EXPORT)
GK_MKARRAY2CSR_PROTO_EX(i, idx_t, METIS_EXPORT)
