...
#define FRENAME(name, dargs, cargs, name1, name2, name3, name4)   \
  METIS_API(int) name1 dargs { return name cargs; }                          \
  METIS_API(int) name2 dargs { return name cargs; }                          \
  METIS_API(int) name3 dargs { return name cargs; }                          \
  METIS_API(int) name4 dargs { return name cargs; }
