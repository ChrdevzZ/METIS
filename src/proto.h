...
METIS_EXPORT graph_t *FixGraph(graph_t *graph);
...
METIS_EXPORT idx_t BlockKWayPartitioning(ctrl_t *ctrl, graph_t *graph, idx_t *part);
METIS_EXPORT idx_t GrowMultisection(ctrl_t *ctrl, graph_t *graph, idx_t nparts, idx_t *where);
METIS_EXPORT void BalanceAndRefineLP(ctrl_t *ctrl, graph_t *graph, idx_t nparts, idx_t *where);
...
METIS_EXPORT void KWayVolUpdate(ctrl_t *ctrl, graph_t *graph, idx_t v, idx_t from,
         ...
         idx_t *modind);
METIS_EXPORT void Greedy_KWayEdgeStats(ctrl_t *ctrl, graph_t *graph);
METIS_EXPORT void Greedy_KWayEdgeCutOptimize(ctrl_t *ctrl, graph_t *graph, idx_t niter);
